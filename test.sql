...
CREATE TABLE 'version_upgrade'(
  ...
  'app_id'  smallint(4) unsigned NOT NULL DEFAULT '0' COMMENT '客户端设备id 1安卓pad 2安卓手机 3ios手机 4ios手机pad',
  'version_id' smallint(4) unsigned DEFAULT '0' COMMENT '大版本号id',
  'version_mini' mediumint(8) unsigned DEFAULT '0' COMMENT '小版本号id',
  'version_code' varchar(10) DEFAULT NULL COMMENT '版本标识 1.2',
  'type' tinyint(2) unsigned DEFAULT NULL COMMENT '是否升级 1升级，0不升级，2强制升级',
  'apk_url' varchar(25) unsigned DEFAULT NULL,
  'upgrade_point' varchar(25) DEFAULT NULL COMMENT '升级提示',
...
CREATE TABLE 'error_log'(
  'id' smallint(4) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id',
  'app_id'  smallint(4) unsigned NOT NULL DEFAULT '0' COMMENT '客户端设备id 1安卓pad 2安卓手机 3ios手机 4ios手机pad',
  'did' smallint(4) unsigned DEFAULT '0' COMMENT 'app类型id',
  'version_id' smallint(4) unsigned DEFAULT '0' COMMENT '大版本号id',
  'version_mini' mediumint(8) unsigned DEFAULT '0' COMMENT '小版本号id',
  'error_log' text COMMENT '按json_encode存储',
  'create_time' int(11) NOT NULL COMMENT '创建时间',
  'update_time' int(11) NOT NULL COMMENT '更新时间',
  PRIMARY KEY ('id')
)ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;
